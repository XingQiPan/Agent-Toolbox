...
```text
插件 manifest -> 工具注册 -> 工具搜索 -> 工具详情 -> 工具执行 -> 文件产物 -> 审计日志 -> 智能体接入清单 -> Web 控制台
```
...
- 智能体接入：展示推荐三步流程、可用接口、请求/返回示例，以及文件/MCP 等规划中能力。
